...
const initialRows = [
  ...
  createData(0, '122481', '24123', '01/01/2021', '01/02/2021', 'Aberto', 'Baixo'),
];
          ...
          <TableContainer component={Paper}>
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
              <TableHead>
                <TableRow>
                  <TableCell>#</TableCell>
                  <TableCell>Ticker FreshDesk</TableCell>
                  <TableCell align="right">Ticket OpenProject</TableCell>
              ...
              <TableBody>
                {tarefas.map((row, indice) => (
                  ...
                  >
                    ...
                    {row.idTarefa !== 0 && ( // A condição row.idTarefa !== 0 é usada para evitar a exclusão do item inicial do array
                      <>
